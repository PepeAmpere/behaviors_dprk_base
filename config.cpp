...
class CfgAvailableBehaviors
{
	...
	class behaviors_dprk_AlternatingAdvancePopek
	{
		icon = "\vbs2\customer\plugins\behaviors_dprk_base\data\aa.paa";
		allowRotate = true; // you also get direction


		displayname = "DPRK Alternating Advance Popek";
		description = "DPRK Alternating Advance Popek";				

		orderName = "AlternatingAdvancePopek"; // it will implicitly have position as well
		prepareActionMessage = "vbs2\vbs_plugins\ai\standard_behaviors\data\scripts\PrepareBTParameters.sqf";
	...
	class behaviors_dprk_AlternatingIdleMudrak
	{
		icon = "\vbs2\customer\plugins\behaviors_dprk_base\data\aa.paa";
		allowRotate = true; // you also get direction


		displayname = "DPRK Debug Alternating Idle Mudrak";
		description = "DPRK Debug Alternating Idle Mudrak";

		orderName = "AlternatingIdleMudrak"; // it will implicitly have position as well
		prepareActionMessage = "vbs2\vbs_plugins\ai\standard_behaviors\data\scripts\PrepareBTParameters.sqf";
	...
	class behaviors_dprk_TestPathVolume
	{
		icon = "\vbs2\customer\plugins\behaviors_dprk_base\data\aa.paa";
		allowRotate = true; // you also get direction
